...
const elementColors = [
    { element: "Al", color: "#00FA9A" }, // 13
    { element: "Sc", color: "#FFB6C1" }, // 21
    { element: "Ti", color: "#B0C4DE" }, // 22
    { element: "V", color: "#7FFFD4" },  // 23
    { element: "Cr", color: "#FF6347" }, // 24
    { element: "Mn", color: "#4682B4" }, // 25
    { element: "Fe", color: "#FF4500" }, // 26
    { element: "Co", color: "#8A2BE2" }, // 27
    { element: "Ni", color: "#2E8B57" }, // 28
    { element: "Cu", color: "#D2691E" }, // 29
    { element: "Zn", color: "#6495ED" }, // 30
    { element: "Ga", color: "#F08080" }, // 31
    { element: "Ge", color: "#E0FFFF" }, // 32
    { element: "Y", color: "#32CD32" },  // 39
    { element: "Zr", color: "#40E0D0" }, // 40
    { element: "Nb", color: "#9ACD32" }, // 41
    { element: "Mo", color: "#FF7F50" }, // 42
    { element: "Tc", color: "#9932CC" }, // 43
    { element: "Ru", color: "#DAA520" }, // 44
    { element: "Rh", color: "#DC143C" }, // 45
    { element: "Pd", color: "#FFD700" }, // 46
    { element: "Ag", color: "#C0C0C0" }, // 47
    { element: "Cd", color: "#B8860B" }, // 48
    { element: "In", color: "#FA8072" }, // 49
    { element: "Sn", color: "#E9967A" }, // 50
    { element: "Sb", color: "#ADD8E6" }, // 51
    { element: "Ce", color: "#8FBC8F" }, // 58
    { element: "Hf", color: "#BA55D3" }, // 72
    { element: "Ta", color: "#87CEFA" }, // 73
    { element: "W", color: "#7FFF00" },  // 74
    { element: "Re", color: "#FFDAB9" }, // 75
    { element: "Os", color: "#FFC0CB" }, // 76
    { element: "Ir", color: "#CD5C5C" }, // 77
    { element: "Pt", color: "#4B0082" }, // 78
    { element: "Au", color: "#FFD700" }, // 79
    { element: "Tl", color: "#FFFACD" }, // 81
    { element: "Pb", color: "#90EE90" }, // 82
    { element: "Bi", color: "#DDA0DD" }  // 83
];
    ...
    svg.append('line')
        ...
        .on("contextmenu", function(event) {
            ...
            contextMenu.style("left", `${event.pageX}px`)
                       .style("top", `${event.pageY}px`)
                       .style("display", "grid"); // Change display to grid
